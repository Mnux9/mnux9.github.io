...
when shooting with a very fast shutter speed necessary for capturing the fast-changing state of the counter. (In retrospect, I would use a higher resistance  
resistor, because the LEDs get overblown when increasing the exposure in GIMP later to see the inactive LEDs.) <br>  
I also added a switch which can half-press the shutter button and get the camera to prepare (like focusing, etc.) to take a picture. <br>  
...
Imaging Resource</a> (a very in-depth camera review site). Mine are about 10 ms off from their results. In my opinion, this could be because  
